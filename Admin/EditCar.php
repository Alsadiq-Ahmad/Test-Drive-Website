   ...
   if(in_array($fileActualExt, $allowed)){
       if($fileError === 0){
           if($fileSize < 1000000){
               ...
               $sql = "UPDATE `car_info` SET model = '$model' , engine = '$engine' ,hp='$horsepower', image='$fileNameNew' WHERE name = '$name'";
...
<section class="add-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <input type="file" required name="file" class="input">

      <input type="submit" value="Edit car" name="add_car" class="btn">
   </form>
